...
\begin{frame}{Deductive Reasoning}
  ...
  \pause
  \bigskip
  Deductive reasoning has been studied since Aristotle 
...
\begin{slide}{A Basic Deductive System}
  ...
  \begin{column}{0.5\textwidth}
          $\typeA,\typeB \dots$ will denote \alert{\underline{propositions}}
...
\begin{frame}{A Basic Deductive System}
  ...
  $\Gamma$ will denote a list of propositions
...
\begin{slide}{Building New Knowledge From Old}
  The following rules are \alert{\underline{derivable}} from the previous system

  \begin{flalign*}
      \infer[]{\Gamma, \typeB, \typeA,\Delta \vljud \typeC}{
      \Gamma, \typeA, \typeB,\Delta \vljud \typeC}
      \hspace{2cm}
      \infer[]{\Gamma,\typeB \vljud \typeA}{\Gamma \vljud \typeA}
  \end{flalign*}

  Proof again by an appeal to your friend \dots\  \alert{\underline{induction}} :-)
  \vfill
  \begin{block}{Exercise}
...
\section{A Simple Denotational Semantics}
...
\begin{slide}{Exercises}
  ...
  \begin{flalign*}
    ...
    \sem{x : \typeA, y : \typeB  \vljud x : \typeA} \\[5pt]
    \sem{\Gamma  \vljud t: \typeA}\ & =\
    \sem{\Gamma  \vljud \langle \pi_1\ t, \pi_2\ t \rangle : \typeA}
    \\[5pt]
